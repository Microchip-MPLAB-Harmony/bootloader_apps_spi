# SAM D21 Xplained Pro Evaluation Kit: Building and Running the SPI Bootloader applications
...
3.  Open the test application project *test\_app/firmware/sam\_d21\_xpro.X* in the IDE
