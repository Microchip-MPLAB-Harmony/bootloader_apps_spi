...
{"0": {
    ...
    "url": "http://localhost:4000/bootloader_apps_spi/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "SPI Bootloader",
    "title": "SPI Bootloader",
    "content": "This example application shows how to use the Bootloader Library to bootload an application using SPI protocol. Bootloader Application . | This is a bootloader application which resides from starting location of the device flash memory | It uses SPI peripheral library in non-interrupt mode | Trigger Methods . | It uses the On board Switch as bootloader trigger pin to force enter the bootloader at reset of device | It checks for bootloader request pattern (0x5048434D) from the starting 16 Bytes of RAM to force enter bootloader at reset of device | . | . SDCARD Host Application . | This is a embedded SPI host application which sends the application image stored in the SD card to the target board over the SPI communication | The user application binary is copied into an SD card and inserted in the SD card connected on the host board . | . Test Application . | This is a test application which resides from end of bootloader size in device flash memory | It will be loaded into flash memory by bootloader application | It blinks an LED and provides console output | It uses the On board Switch to trigger the bootloader from firmware (May not be supported on all devices) . | Once the switch is pressed it loads first 16 bytes of RAM with bootloader request pattern (0x5048434D) and resets the device | . | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/readme.html#spi-bootloader",
    "relUrl": "/apps/spi_bootloader/readme.html#spi-bootloader"
  },"2": {
    "doc": "SPI Bootloader",
    "title": "Development Kits",
    "content": "The following table provides links to documentation on how to build and run SPI bootloader on different development kits . | Development Kit | . | PIC32MM USB Curiosity Development Kit | . | SAM D21 Xplained Pro Evaluation Kit | . | SAM E54 Xplained Pro Evaluation Kit | . | SAM E70 Xplained Pro Evaluation Kit | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/readme.html#development-kits",
    "relUrl": "/apps/spi_bootloader/readme.html#development-kits"
  },"3": {
    "doc": "SPI Bootloader",
    "title": "SPI Bootloader",
    ...
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/readme.html",
    "relUrl": "/apps/spi_bootloader/readme.html"
  },"4": {
    ...
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_application.html#configuring-an-application-to-be-bootloaded",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_application.html#configuring-an-application-to-be-bootloaded"
  },"5": {
    "doc": "Application Configurations",
    "title": "Application Configurations",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_application.html",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_application.html"
  },"6": {
    ...
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_application_sam.html#configuring-an-application-to-be-bootloaded-for-cortex-m-based-mcus",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_application_sam.html#configuring-an-application-to-be-bootloaded-for-cortex-m-based-mcus"
  },"7": {
    "doc": "Application Configurations for CORTEX-M based MCUs",
    ...
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_application_sam.html#application-settings-in-mcc-system-configuration",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_application_sam.html#application-settings-in-mcc-system-configuration"
  },"8": {
    "doc": "Application Configurations for CORTEX-M based MCUs",
    ...
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_application_sam.html#mplab-x-settings",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_application_sam.html#mplab-x-settings"
  },"9": {
    "doc": "Application Configurations for CORTEX-M based MCUs",
    ...
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_application_sam.html#additional-settings-optional",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_application_sam.html#additional-settings-optional"
  },"10": {
    "doc": "Application Configurations for CORTEX-M based MCUs",
    "title": "Application Configurations for CORTEX-M based MCUs",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_application_sam.html",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_application_sam.html"
  },"11": {
    "doc": "Configuring SDCARD Host applications",
    "title": "Configuring the SDCARD Host applications",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_host_app_sdcard.html#configuring-the-sdcard-host-applications",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_host_app_sdcard.html#configuring-the-sdcard-host-applications"
  },"12": {
    "doc": "Configuring SDCARD Host applications",
    "title": "Downloading the application",
    "content": "To clone or download this application from Github,go to the main page of this repository and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following these instructions . Path of the SDCARD host applications within the repository is apps/spi_bootloader/ . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_host_app_sdcard.html#downloading-the-application",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_host_app_sdcard.html#downloading-the-application"
  },"13": {
    "doc": "Configuring SDCARD Host applications",
    "title": "Configuring the SDCARD Host application",
    "content": "Follow below steps only when Host development kit is different than Target Development Kit . | Open the host_app_sdcard/firmware/*.X project in MPLABX IDE . | Open the “user.h” file as shown below: . | In the “user.h” file specify the Bootloader Target Device used using the predefined macros #define APP_SPI_BOOTLOADER_TARGET_DEVICE SAM_D21_XPRO . | Navigate to the #if block for the specified Bootloader Target Device and verify the below settings are as expected. | APP_BINARY_FILE: Name of the Application binary copied to the SDCARD | APP_ERASE_PAGE_SIZE: Erase page size of the target (target = MCU being programmed) | APP_PROGRAM_PAGE_SIZE: Program page size of the target (target = MCU being programmed). | The macro can either be set to the program page size or can be set to the size of the erase page size of the target. | In the demo example, the macro is set equal to the size of the erase page. | On embedded host where RAM is limited, the macro may be set to the actual program page size to reduce the RAM used to hold the program data. | For example, for SAM D20, the macro can be set either to 64 (program page size) or 256 (erase page size) | . | . | APP_IMAGE_START_ADDR: User application start address (This value should be same as the application start address specified in Application Configurations steps). | If the bootloader itself is being upgraded then the APP_IMAGE_START_ADDR must be set to 0x00 (start of bootloader) | Ensure that the bootloader and application are also configured with the same value of user application start address | . | . | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_host_app_sdcard.html#configuring-the-sdcard-host-application",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_host_app_sdcard.html#configuring-the-sdcard-host-application"
  },"14": {
    "doc": "Configuring SDCARD Host applications",
    "title": "Configuring SDCARD Host applications",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_host_app_sdcard.html",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_host_app_sdcard.html"
  },"15": {
    "doc": "Host Application Configurations",
    "title": "Configuring a Host Application used to send an application binary to bootloader",
    "content": ". | To configure SDCARD based host application refer to SDCARD Host Application Configuration | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_host_application.html#configuring-a-host-application-used-to-send-an-application-binary-to-bootloader",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_host_application.html#configuring-a-host-application-used-to-send-an-application-binary-to-bootloader"
  },"16": {
    "doc": "Host Application Configurations",
    "title": "Host Application Configurations",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_configure_host_application.html",
    "relUrl": "/apps/spi_bootloader/docs/readme_configure_host_application.html"
  },"17": {
    "doc": "Building and Running on PIC32MM USB Curiosity Development Board",
    "title": "Building and Running the SPI Bootloader applications",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html#building-and-running-the-spi-bootloader-applications",
    "relUrl": "/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html#building-and-running-the-spi-bootloader-applications"
  },"18": {
    "doc": "Building and Running on PIC32MM USB Curiosity Development Board",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github,go to the main page of this repository and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following these instructions . Path of the application within the repository is apps/spi_bootloader/ . To build the application, refer to the following table and open the project using its IDE. Bootloader Application . | Project Name | Description | . | bootloader/firmware/pic32mm_usb_curiosity.X | MPLABX Project for PIC32MM USB Curiosity Development Board | . Test Application . | Project Name | Description | . | test_app/firmware/pic32mm_usb_curiosity.X | MPLABX Project for PIC32MM USB Curiosity Development Board | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html#downloading-and-building-the-application",
    "relUrl": "/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html#downloading-and-building-the-application"
  },"19": {
    "doc": "Building and Running on PIC32MM USB Curiosity Development Board",
    "title": "Setting up PIC32MM USB Curiosity Development Board",
    "content": ". | SAME54 Xplained Pro Evaluation Kit is used for Host Development kit . | PIC32MM USB Curiosity Development Board is used for Target Development kit . | Connect the MOSI Pin 16 (PC04) on EXT2 of the Host development kit to the Pin 05 (PA07) on J12 header of the Target development kit | Connect the MISO Pin 17 (PC07) on EXT2 of the Host development kit to the Pin 06 (PA08) on J12 header of the Target development kit | Connect the CS Pin 15 (PC06) on EXT2 of the Host development kit to the Pin 03 (PC11) on J12 header of the Target development kit | Connect the SCK Pin 18 (PC05) on EXT2 of the Host development kit to the Pin 04 (PA10) on J12 header of the Target development kit | Connect the BUSY Pin 09 (PD00) on EXT2 of the Host development kit to the Pin 02 (PC14) on J12 header of the Target development kit | Connect a ground wire between Host development kit and Target development kit | Connect the Debug USB port on the Host development kit to the computer using a micro USB cable | Connect the Debug USB port on the Target development kit to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html#setting-up-pic32mm-usb-curiosity-development-board",
    "relUrl": "/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html#setting-up-pic32mm-usb-curiosity-development-board"
  },"20": {
    "doc": "Building and Running on PIC32MM USB Curiosity Development Board",
    "title": "Building and Configuring SPI Host Applications",
    "content": "Using SPI SDCARD Host application to send the application binary to Target development kit . If the SDCARD Host Development Kit being used is SAM E54 Xplained Pro Evaluation Kit then follow the steps mentioned in Configuring SDCARD Host application project . | Open the SDCARD host application project host_app_sdcard/firmware/sam_e54_xpro.X in the IDE . | If a SDCARD host application project of different development kit is used then open that project in the IDE | . | Build and program the SDCARD host application using the IDE on to the SPI host dvelopment kit . | Open the test application project test_app/firmware/pic32mm_usb_curiosity.X in the IDE | Build the project to generate the binary (Do not program the binary) . | Copy the application binary into the SD card and insert the SD card in the SD card slot available on the SAM E54 Xplained Pro Evaluation Kit . | Open the Terminal application (Ex.:Tera Term) on the computer | Configure the serial port settings for Host Development kit as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Jump to Running The Application | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html#building-and-configuring-spi-host-applications",
    "relUrl": "/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html#building-and-configuring-spi-host-applications"
  },"21": {
    "doc": "Building and Running on PIC32MM USB Curiosity Development Board",
    "title": "Running the Application",
    "content": ". | Open the bootloader project bootloader/firmware/pic32mm_usb_curiosity.X in the IDE | Build and program the application using the IDE on to the Target development kit . | If the test application is being programmed, Open the Terminal application (Ex.:Tera Term) on the computer and configure the serial port settings for Target Development kit as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Press the Switch SW0 on the Host development kit to trigger programming of the application binary | Once the programming is complete, . | LED0 on the Host development kit will be turned on indicating success . | The target development kit will be reset. Upon re-start, the boot-loader will jump to the user application . | If the test application is programmed then LED1 should start blinking and you should see below output on the Target development kit console . | . | Press and hold the Switch S1 to trigger Bootloader from test application and you should see below output . | Press Reset button on the Host development kit to reprogram the application binary | Repeat Steps 4-5 once . | This step is to verify that bootloader is running after triggering bootloader from test application in Step 6 | . | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html#running-the-application",
    "relUrl": "/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html#running-the-application"
  },"22": {
    "doc": "Building and Running on PIC32MM USB Curiosity Development Board",
    ...
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html#additional-steps-optional",
    "relUrl": "/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html#additional-steps-optional"
  },"23": {
    "doc": "Building and Running on PIC32MM USB Curiosity Development Board",
    "title": "Building and Running on PIC32MM USB Curiosity Development Board",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html",
    "relUrl": "/apps/spi_bootloader/docs/readme_pic32mm_usb_curiosity.html"
  },"24": {
    "doc": "Building and Running on SAM D21 Xplained Pro Evaluation Kit",
    "title": "Building and Running the SPI Bootloader applications",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_d21_xpro.html#building-and-running-the-spi-bootloader-applications",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_d21_xpro.html#building-and-running-the-spi-bootloader-applications"
  },"25": {
    "doc": "Building and Running on SAM D21 Xplained Pro Evaluation Kit",
    "title": "Downloading and building the application",
    ...
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_d21_xpro.html#downloading-and-building-the-application",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_d21_xpro.html#downloading-and-building-the-application"
  },"26": {
    "doc": "Building and Running on SAM D21 Xplained Pro Evaluation Kit",
    "title": "Setting up SAM D21 Xplained Pro Evaluation Kit",
    "content": ". | SAME54 Xplained Pro Evaluation Kit is used for Host Development kit | SAM D21 Xplained Pro Evaluation Kit is used for Target Development kit . | Connect the MOSI Pin 16 (PC04) on EXT2 of the Host development kit to the Pin 17 (PA16) on EXT2 header of the Target development kit | Connect the MISO Pin 17 (PC07) on EXT2 of the Host development kit to the Pin 16 (PA18) on EXT2 header of the Target development kit | Connect the CS Pin 15 (PC06) on EXT2 of the Host development kit to the Pin 15 (PA17) on EXT2 header of the Target development kit | Connect the SCK Pin 18 (PC05) on EXT2 of the Host development kit to the Pin 18 (PA19) on EXT2 header of the Target development kit | Connect the BUSY Pin 09 (PD00) on EXT2 of the Host development kit to the Pin 09 (PB14) on EXT2 header of the Target development kit | Connect a ground wire between Host development kit and Target development kit | Connect the Debug USB port on the Host development kit to the computer using a micro USB cable | Connect the Debug USB port on the Target development kit to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_d21_xpro.html#setting-up-sam-d21-xplained-pro-evaluation-kit",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_d21_xpro.html#setting-up-sam-d21-xplained-pro-evaluation-kit"
  },"27": {
    "doc": "Building and Running on SAM D21 Xplained Pro Evaluation Kit",
    "title": "Building and Configuring SPI Host Applications",
    "content": "Using SPI SDCARD Host application to send the application binary to Target development kit . if SDCARD Host Development Kit being used is SAM E54 Xplained Pro Evaluation Kit, follow the steps mentioned in Configuring SDCARD Host application project . | Open the SDCARD host application project host_app_sdcard/firmware/sam_e54_xpro.X in the IDE . | If a SDCARD host application project of different development kit is used then open that project in the IDE | . | Build and program the SDCARD host application using the IDE on to the SPI host dvelopment kit . | Open the test application project test_app/firmware/sam_d21_xpro.X in the IDE | Build the project to generate the binary (Do not program the binary) . | Copy the application binary into the SD card and insert the SD card in the SD card slot available on the SAM E54 Xplained Pro Evaluation Kit . | Open the Terminal application (Ex.:Tera Term) on the computer | Configure the serial port settings for Host Development kit as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Jump to Running The Application | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_d21_xpro.html#building-and-configuring-spi-host-applications",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_d21_xpro.html#building-and-configuring-spi-host-applications"
  },"28": {
    "doc": "Building and Running on SAM D21 Xplained Pro Evaluation Kit",
    "title": "Running the Application",
    ...
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_d21_xpro.html#running-the-application",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_d21_xpro.html#running-the-application"
  },"29": {
    "doc": "Building and Running on SAM D21 Xplained Pro Evaluation Kit",
    "title": "Additional Steps (Optional)",
    "content": "Using SDCARD Host application . | If multiple Target development kit are to be programmed using the same Host development kit then refer to Configuring SDCARD Host application project . | Once done repeat the applicable steps mentioned in Running The Application . | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_d21_xpro.html#additional-steps-optional",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_d21_xpro.html#additional-steps-optional"
  },"30": {
    "doc": "Building and Running on SAM D21 Xplained Pro Evaluation Kit",
    "title": "Building and Running on SAM D21 Xplained Pro Evaluation Kit",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_d21_xpro.html",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_d21_xpro.html"
  },"31": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Building and Running the SPI Bootloader applications",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e54_xpro.html#building-and-running-the-spi-bootloader-applications",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e54_xpro.html#building-and-running-the-spi-bootloader-applications"
  },"32": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Downloading and building the application",
    ...
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e54_xpro.html#downloading-and-building-the-application",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e54_xpro.html#downloading-and-building-the-application"
  },"33": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Setting up SAM E54 Xplained Pro Evaluation Kit",
    "content": ". | SAM E54 Xplained Pro Evaluation Kit is used for Host Development kit and Target Development kit . | Connect the MOSI Pin 16 (PC04) on EXT2 of the Host development kit to the Pin 16 (PC04) on EXT2 header of the Target development kit | Connect the MISO Pin 17 (PC07) on EXT2 of the Host development kit to the Pin 17 (PC07) on EXT2 header of the Target development kit | Connect the CS Pin 15 (PC06) on EXT2 of the Host development kit to the Pin 15 (PC06) on EXT2 header of the Target development kit | Connect the SCK Pin 18 (PC05) on EXT2 of the Host development kit to the Pin 18 (PC05) on EXT2 header of the Target development kit | Connect the BUSY Pin 09 (PD00) on EXT2 of the Host development kit to the Pin 09 (PD00) on EXT2 header of the Target development kit | Connect a ground wire between Host development kit and Target development kit | Connect the Debug USB port on the Host development kit to the computer using a micro USB cable | Connect the Debug USB port on the Target development kit to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e54_xpro.html#setting-up-sam-e54-xplained-pro-evaluation-kit",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e54_xpro.html#setting-up-sam-e54-xplained-pro-evaluation-kit"
  },"34": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Building and Configuring SPI Host Applications",
    "content": "Using SPI SDCARD Host application to send the application binary to Target development kit . if SDCARD Host Development Kit being used is SAM E54 Xplained Pro Evaluation Kit, follow the steps mentioned in Configuring SDCARD Host application project . | Open the SDCARD host application project host_app_sdcard/firmware/sam_e54_xpro.X in the IDE . | If a SDCARD host application project of different development kit is used then open that project in the IDE | . | Build and program the SDCARD host application using the IDE on to the SPI host dvelopment kit . | Open the test application project test_app/firmware/sam_e54_xpro.X in the IDE | Build the project to generate the binary (Do not program the binary) . | Copy the application binary into the SD card and insert the SD card in the SD card slot available on the SAM E54 Xplained Pro Evaluation Kit . | Open the Terminal application (Ex.:Tera Term) on the computer | Configure the serial port settings for Host Development kit as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Jump to Running The Application | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e54_xpro.html#building-and-configuring-spi-host-applications",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e54_xpro.html#building-and-configuring-spi-host-applications"
  },"35": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Running the Application",
    ...
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e54_xpro.html#running-the-application",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e54_xpro.html#running-the-application"
  },"36": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Additional Steps (Optional)",
    "content": "Using SDCARD Host application . | If multiple Target development kit are to be programmed using the same Host development kit then refer to Configuring SDCARD Host application project . | Once done repeat the applicable steps mentioned in Running The Application . | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e54_xpro.html#additional-steps-optional",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e54_xpro.html#additional-steps-optional"
  },"37": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e54_xpro.html",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e54_xpro.html"
  },"38": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Kit",
    "title": "Building and Running the SPI Bootloader applications",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e70_xpro.html#building-and-running-the-spi-bootloader-applications",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e70_xpro.html#building-and-running-the-spi-bootloader-applications"
  },"39": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Kit",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github,go to the main page of this repository and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following these instructions . Path of the application within the repository is apps/spi_bootloader/ . To build the application, refer to the following table and open the project using its IDE. Bootloader Application . | Project Name | Description | . | bootloader/firmware/sam_e70_xpro.X | MPLABX Project for SAM E70 Xplained Ultra Kit | . Test Application . | Project Name | Description | . | test_app/firmware/sam_e54_xpro.X | MPLABX Project for SAM E70 Xplained Ultra Kit | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e70_xpro.html#downloading-and-building-the-application",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e70_xpro.html#downloading-and-building-the-application"
  },"40": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Kit",
    "title": "Setting up SAM E70 Xplained Ultra Kit",
    "content": ". | SAM E54 Xplained Pro Evaluation Kit is used for Host Development kit | SAM E70 Xplained Ultra Kit is used for Target Development kit . | Connect the MOSI Pin 16 (PC04) on EXT2 of the Host development kit to the Pin 16 (PD21) on EXT1 header of the Target development kit | Connect the MISO Pin 17 (PC07) on EXT2 of the Host development kit to the Pin 17 (PD20) on EXT1 header of the Target development kit | Connect the CS Pin 15 (PC06) on EXT2 of the Host development kit to the Pin 06 (PB02) on EXT1 header of the Target development kit | Connect the SCK Pin 18 (PC05) on EXT2 of the Host development kit to the Pin 18 (PD22) on EXT1 header of the Target development kit | Connect the BUSY Pin 09 (PD00) on EXT2 of the Host development kit to the Pin 09 (PD28) on EXT1 header of the Target development kit | Connect a ground wire between Host development kit and Target development kit | Connect the Debug USB port on the Host development kit to the computer using a micro USB cable | Connect the Debug USB port on the Target development kit to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e70_xpro.html#setting-up-sam-e70-xplained-ultra-kit",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e70_xpro.html#setting-up-sam-e70-xplained-ultra-kit"
  },"41": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Kit",
    "title": "Building and Configuring SPI Host Applications",
    "content": "Using SPI SDCARD Host application to send the application binary to Target development kit . if SDCARD Host Development Kit being used is SAM E54 Xplained Pro Evaluation Kit, follow the steps mentioned in Configuring SDCARD Host application project . | Open the SDCARD host application project host_app_sdcard/firmware/sam_e54_xpro.X in the IDE . | If a SDCARD host application project of different development kit is used then open that project in the IDE | . | Build and program the SDCARD host application using the IDE on to the SPI host dvelopment kit . | Open the test application project test_app/firmware/sam_e70_xult.X in the IDE | Build the project to generate the binary (Do not program the binary) . | Copy the application binary into the SD card and insert the SD card in the SD card slot available on the SAM E54 Xplained Pro Evaluation Kit . | Open the Terminal application (Ex.:Tera Term) on the computer | Configure the serial port settings for Host Development kit as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Jump to Running The Application | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e70_xpro.html#building-and-configuring-spi-host-applications",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e70_xpro.html#building-and-configuring-spi-host-applications"
  },"42": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Kit",
    "title": "Running the Application",
    "content": ". | Open the bootloader project bootloader/firmware/sam_e70_xult.X in the IDE | Build and program the application using the IDE on to the Target development kit | If the test application is being programmed, Open the Terminal application (Ex.:Tera Term) on the computer and configure the serial port settings for Target Development kit as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Press the Switch SW0 on the Host development kit to trigger programming of the application binary | Once the programming is complete, . | LED3 on the Host development kit will be turned on indicating success . | If SDCARD Host application was used to program the application binary following message will be displayed on the terminal of Host development kit . | The target development kit will be reset. Upon re-start, the boot-loader will jump to the user application . | If the test application is programmed then LED3 should start blinking and you should see below output on the Target development kit console . | . | Press and hold the Switch SW0 to trigger Bootloader from test application and you should see below output . | Press Reset button on the Host development kit to reprogram the application binary | Repeat Steps 4-5 once . | This step is to verify that bootloader is running after triggering bootloader from test application in Step 6 | . | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e70_xpro.html#running-the-application",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e70_xpro.html#running-the-application"
  },"43": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Kit",
    "title": "Additional Steps (Optional)",
    "content": "Using SDCARD Host application . | If multiple Target development kit are to be programmed using the same Host development kit then refer to Configuring SDCARD Host application project . | Once done repeat the applicable steps mentioned in Running The Application . | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e70_xpro.html#additional-steps-optional",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e70_xpro.html#additional-steps-optional"
  },"44": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Kit",
    "title": "Building and Running on SAM E70 Xplained Ultra Kit",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_spi/apps/spi_bootloader/docs/readme_sam_e70_xpro.html",
    "relUrl": "/apps/spi_bootloader/docs/readme_sam_e70_xpro.html"
  },"45": {
    "doc": "Release notes",
    "title": "Microchip MPLAB® Harmony 3 Release Notes",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_spi/release_notes.html#microchip-mplab-harmony-3-release-notes",
    "relUrl": "/release_notes.html#microchip-mplab-harmony-3-release-notes"
  },"46": {
    "doc": "Release notes",
    "title": "SPI Bootloader Applications Release v3.0.0",
    "content": "New Features . | This release provides SPI Bootloader Demo Applications for PIC32MM, SAM D21/DA1, SAM D5x/E5x and SAM E70/S70/V70/V71 family of 32-bit microcontrollers. | . Development kit and demo application support . | The following table provides bootloader demo applications available for different development kits. | Product Family | Development Kits | SPI | SPI Fail Safe | . | PIC32MM | PIC32MM USB Curiosity Development Board | Yes | NA | . | SAM D21/DA1 | SAM D21 Xplained Pro Evaluation Kit | Yes | NA | . | SAM D5x/E5x | SAM E54 Xplained Pro Evaluation Kit | Yes | No | . | SAM E70/S70/V70/V71 | SAM E70 Xplained Ultra Evaluation Kit | Yes | NA | . | NA: Lack of product capability . | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.00 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.1.17 | . | MPLAB® XC32 C/C++ Compiler v4.10 | . ",
    "url": "http://localhost:4000/bootloader_apps_spi/release_notes.html#spi-bootloader-applications-release-v300",
    "relUrl": "/release_notes.html#spi-bootloader-applications-release-v300"
  },"47": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_spi/release_notes.html",
    "relUrl": "/release_notes.html"
  },"48": {
    "doc": "SPI Bootloader Applications",
    "title": "SPI Bootloader Applications",
    "content": "![Microchip logo](https://raw.githubusercontent.com/wiki/Microchip-MPLAB-Harmony/Microchip-MPLAB-Harmony.github.io/images/microchip_logo.png) # MPLAB® Harmony 3 SPI Bootloader Application Examples MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 SPI Bootloader application examples - [Release Notes](/bootloader_apps_spi/release_notes.html) - [MPLAB® Harmony License](/bootloader_apps_spi/mplab_harmony_license.html) To clone or download these application from Github,go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_spi) and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following [these instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki) ## Contents Summary | Folder | Description | --- | --- | apps | SPI Bootloader example applications | ## Bootloader Examples The following applications are provided to demonstrate the SPI bootloader | Name | Description | --------- | ----------- | [SPI Bootloader](/bootloader_apps_spi/apps/spi_bootloader/readme.html) | This example application shows how to use the Bootloader Library to bootload an application using SPI protocol | ## Bootloader Library Refer to [Bootloader Library Help](https://microchip-mplab-harmony.github.io/bootloader) for understanding - Bootloader framework - How the Bootloader library works - Bootloader library configurations - Bootloader memory layout ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_spi/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/bootloader_apps_spi.svg)](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_spi/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/bootloader_apps_spi.svg)](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_spi/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/bootloader_apps_spi.svg)](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_spi/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/bootloader_apps_spi.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/bootloader_apps_spi.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/bootloader_apps_spi.svg?style=social)]() ",
    "url": "http://localhost:4000/bootloader_apps_spi/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "bootloader_apps_spi";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "SPI Bootloader Applications";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/bootloader_apps_spi/assets/css/just-the-docs-' + theme + '.css');
}
